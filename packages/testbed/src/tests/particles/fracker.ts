...
export class Fracker extends testbed.Test {
    ...
    public CreatePlayer(): void {
        ...
        shape.SetAsBox(
            ...
            new b2.Vec2(FrackerSettings.k_tileHalfWidth, FrackerSettings.k_tileHalfHeight),
            0
        );
    ...
    public CreateReservoirBlock(x: number, y: number, material: Fracker_Material): void {
        ...
        pd.flags =
            ...
            b2.ParticleFlag.b2_destructionListenerParticle;
        pd.shape = shape;
    ...
    public DrawPlayer(): void {
        this.DrawQuad(
            ...
            Fracker.LerpColor(
                ...
                b2.Max(this.m_frackingFluidChargeTime / FrackerSettings.k_frackingFluidChargeTime, 0.0)
            ),
            true
        );
    }
