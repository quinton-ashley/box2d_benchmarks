...
class ParticleVFX {
    ...
    constructor(
        particleSystem: b2.ParticleSystem,
        origin: b2.Vec2,
        size: number,
        speed: number,
        lifetime: number,
        particleFlags: b2.ParticleFlag
    ) {
...
export class Sparky extends testbed.Test {
    ...
    public AddVFX(p: b2.Vec2, particleFlags: b2.ParticleFlag) {
        ...
        this.m_VFX[this.m_VFXIndex] = new ParticleVFX(
            ...
            p,
            testbed.RandomFloat(1.0, 2.0),
            testbed.RandomFloat(10.0, 20.0),
            testbed.RandomFloat(0.5, 1.0),
            particleFlags
        );
    ...
    public CreateWalls() {
        // Create the walls of the world.
        {
            ...
            {
                const shape = new b2.PolygonShape();
                const vertices = [new b2.Vec2(-40, 40), new b2.Vec2(40, 40), new b2.Vec2(40, 50), new b2.Vec2(-40, 50)];
                shape.Set(vertices, 4);
                ground.CreateFixture(shape, 0.0);
            }
            ...
            {
                const shape = new b2.PolygonShape();
                const vertices = [new b2.Vec2(20, -10), new b2.Vec2(40, -10), new b2.Vec2(40, 50), new b2.Vec2(20, 50)];
                shape.Set(vertices, 4);
                ground.CreateFixture(shape, 0.0);
            }
        }
