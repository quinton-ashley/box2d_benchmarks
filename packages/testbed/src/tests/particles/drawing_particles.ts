...
export class DrawingParticles extends testbed.Test {
    ...
    public static readonly k_paramValues = [
        new testbed.ParticleParameterValue(
            b2.ParticleFlag.b2_zombieParticle,
    ...
    constructor() {
...

        {
...

            {
                ...
                const vertices = [new b2.Vec2(-4, -2), new b2.Vec2(4, -2), new b2.Vec2(4, 0), new b2.Vec2(-4, 0)];
            ...
            {
                const shape = new b2.PolygonShape();
                const vertices = [new b2.Vec2(-4, -2), new b2.Vec2(-2, -2), new b2.Vec2(-2, 6), new b2.Vec2(-4, 6)];
                shape.Set(vertices, 4);
                ground.CreateFixture(shape, 0.0);
            }
            ...
            {
                const shape = new b2.PolygonShape();
                const vertices = [new b2.Vec2(2, -2), new b2.Vec2(4, -2), new b2.Vec2(4, 6), new b2.Vec2(2, 6)];
                shape.Set(vertices, 4);
                ground.CreateFixture(shape, 0.0);
            }
            ...
            {
                const shape = new b2.PolygonShape();
                const vertices = [new b2.Vec2(-4, 4), new b2.Vec2(4, 4), new b2.Vec2(4, 6), new b2.Vec2(-4, 6)];
                shape.Set(vertices, 4);
                ground.CreateFixture(shape, 0.0);
            }
        }
    ...
    public DetermineParticleParameter() {
        if (this.m_drawing) {
            if (
                this.m_groupFlags ===
                (b2.ParticleGroupFlag.b2_rigidParticleGroup | b2.ParticleGroupFlag.b2_solidParticleGroup)
            ) {
        ...
        if (this.m_drawing) {
            ...
            if (
                this.m_particleFlags &
                    (b2.ParticleFlag.b2_wallParticle |
                        b2.ParticleFlag.b2_springParticle |
                        b2.ParticleFlag.b2_elasticParticle) ||
